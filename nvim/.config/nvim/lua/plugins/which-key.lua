local function setup_mappings()
  ...
  wk.add({
    { "<leader>n", ":NvimTreeToggle<CR>", group = "Open File Tree" },
    { "<leader>f", ":Telescope find_files<CR>", group = "Find File" },
    { "<leader>g", group = "gpt" },
    -- VISUAL mode mappings
    {
        ...
        nowait = true,
        remap = false,
        { "<leader>g<C-t>", ":<C-u>'<,'>GpChatNew tabnew<cr>", desc = "ChatNew tabnew" },
        { "<leader>g<C-v>", ":<C-u>'<,'>GpChatNew vsplit<cr>", desc = "ChatNew vsplit" },
        { "<leader>g<C-x>", ":<C-u>'<,'>GpChatNew split<cr>", desc = "ChatNew split" },
    ...
    -- NORMAL mode mappings
    {
        ...
        nowait = true,
        remap = false,
        { "<leader>g<C-t>", "<cmd>GpChatNew tabnew<cr>", desc = "New Chat tabnew" },
        { "<leader>g<C-v>", "<cmd>GpChatNew vsplit<cr>", desc = "New Chat vsplit" },
        { "<leader>g<C-x>", "<cmd>GpChatNew split<cr>", desc = "New Chat split" },
